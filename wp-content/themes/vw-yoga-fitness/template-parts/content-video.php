      ...
      <?php if( get_theme_mod( 'vw_yoga_fitness_toggle_postdate',true) != '' || get_theme_mod( 'vw_yoga_fitness_toggle_author',true) != '' || get_theme_mod( 'vw_yoga_fitness_toggle_comments',true) != '' || get_theme_mod( 'vw_yoga_fitness_toggle_time',true) != '') { ?>
        <div class="post-info">
          ...
          <?php if(get_theme_mod('vw_yoga_fitness_toggle_author',true)==1){ ?>
            <span>|</span> <i class="<?php echo esc_attr(get_theme_mod('vw_yoga_fitness_toggle_author_icon','far fa-user')); ?>"></i><span class="entry-author"><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php the_author(); ?><span class="screen-reader-text"><?php the_author(); ?></span></a></span>
          <?php } ?>

          <?php if(get_theme_mod('vw_yoga_fitness_toggle_comments',true)==1){ ?>
            <span>|</span> <i class="<?php echo esc_attr(get_theme_mod('vw_yoga_fitness_toggle_comments_icon','fas fa-comments')); ?>"></i><span class="entry-comments"><?php comments_number( __('0 Comment', 'vw-yoga-fitness'), __('0 Comments', 'vw-yoga-fitness'), __('% Comments', 'vw-yoga-fitness') ); ?> </span>
          <?php } ?>
        ...
        <p>
          ...
          if($vw_yoga_fitness_theme_lay == 'Excerpt'){ ?>
            <?php if(get_the_excerpt()) { ?>
             <?php $excerpt = get_the_excerpt(); echo esc_html( vw_yoga_fitness_string_limit_words( $excerpt, esc_attr(get_theme_mod('vw_yoga_fitness_excerpt_number','30')))); ?> <?php echo esc_html(get_theme_mod('vw_yoga_fitness_excerpt_suffix',''));?>
            <?php }?>
          <?php }?>
        </p>
      </div>
